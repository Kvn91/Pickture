<div id="menu">
			...
			<div id="sous_menu">
				<div id="sous_menu_1">
					<h3>Menu</h3>
					<ul id="liste_menu">
						<a href="index.php"><li id="home"><span class="tool_tip">Accueil</span></li></a>
						<a href="galerie/index.php"><li id="galerie"><span class="tool_tip">Galerie</span></li></a>
						<a href="Concours/mur.php"><li id="mur"><span class="tool_tip">Mur</span></li></a>
					</ul>
				</div>
