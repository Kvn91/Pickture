							...
							<?php
								...
								for ( $i=0; $i<$nombreImages; $i++) {
									...
									if ($valide == 1) {
										...
										echo '<li class="view"><div class="back"><div class="lien_full"><input type="hidden" value="'.$image_full.'"></input><input type="hidden" value="'.$srcX.'"></input><input type="hidden" value="'.$srcY.'"></input>Full</div><div id="test" class="vote"><input type="hidden" value="'.$id_oeuvre.'"></input></div><div id="'.$id_oeuvre.'" class="div_vote"></div></div><img src="http://www.pickture.monkeyfactory.fr/Concours/'.$image_concours.'" alt="1"></li>';				
									}
								}
							?>
						</ul>	
